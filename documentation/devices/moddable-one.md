...
3. Build and deploy the app with `mcconfig`.
	...
	The [examples readme](https://github.com/Moddable-OpenSource/moddable/blob/public/examples) contains additional information about other commonly used `mcconfig` arguments for screen rotation, Wi-Fi configuration, and more.
...
The Moddable SDK has over 150 [example apps](https://github.com/Moddable-OpenSource/moddable/blob/public/examples) that demonstrate how to use its many features. The vast majority of these examples run on Moddable One. 
