		...
		$display = $parsedown->text($text);
	 	...
	 	echo str_replace(
	 		...
	 		array(
	 				...
	 				'xs/xsbug.md',
	 				'./commodetto.md',
	 				'.../index.php/defines.md',
	 				'../commodetto/commodetto.md',
	 				'../piu/piu.md',
	 				'.../index.php/XS%20Differences.md',
	 				'./manifest.md',
	 				'.../index.php/XS%20in%20C.md',
	 				'./XS%20%Platforms.md',
	 				'./XS%20Conformance.md',
	 				'.../index.php/XS%20Platforms.md',
					'./poco.md',
					'../index.php#devices/moddable-zero.md',
					'../index.php#devices/moddable-one.md',
					'../index.php#devices/moddable-two.md',
					'../index.php#devices/moddable-three.md',
					'../documentation/displays/wiring-guide-adafruit-OLED.md',
					'../documentation/displays/wiring-guide-adafruit-1.8-st7735.md',
					'../documentation/displays/wiring-guide-crystalfontz-eink.md',
					'../documentation/displays/wiring-guide-sharp-memory-2.7-spi.md',
					'../documentation/displays/wiring-guide-sharp-memory-1.3-spi.md',
					'../documentation/displays/wiring-guide-sparkFun-teensyview-spi.md',
					'../documentation/displays/wiring-guide-switch-science-LCD.md',
					'../documentation/displays/wiring-guide-generic-2.8-CPT-spi.md',
					'../documentation/displays/wiring-guide-generic-2.4-spi-esp32.md'
	 		...
	 		array(
	 				...
	 				'./docview.php?sec_id=../xs&d_id=XS%20Differences',
