 ...
 function createTOC($dir = '', $currDir = '')
 {
    ...
    foreach($toc as $element)
    {
        ...
        else // If a file
        {
            ...
            $class = (in_array($element, $root_files)) ? 'getstarted' : '';

            echo '<a href="web/docview.php?sec_id=../' . strtolower($currDir) . '&d_id=' . urlencode($element_title) . '" type="button" class="list-group-item '. $class . '">' . ucwords($element_title) . '</a>';
        }
    }
